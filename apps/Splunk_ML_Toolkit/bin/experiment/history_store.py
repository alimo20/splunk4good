...
import cexc
from experiment_validation import json_keys, validate_experiment_history_json
    ...
    def _transform_request_options(self, rest_options, url_parts, request):
        ...
        if rest_options['method'] == 'POST':
            ...
            try:
                ...
                logger.error(str(e))
                raise SplunkRestProxyException('Cannot validate experiment history', logging.ERROR, httplib.BAD_REQUEST)
